...
>
> Creado: 2026-07-02. Última actualización: 2026-09-14 (**preparación del
...
> `businessNameOptional`. Hasta ese push, producción sigue sirviendo `main` =
> `bf08618` (candado activo en el frontend Y, desde hoy, también en la
> función). Para retomar la reparación del alta en `dev`: los dos flags en
> `true` sin deployar; para reactivarla en producción: los dos en `true` +
> deploy del frontend + redeploy de la función.
>
