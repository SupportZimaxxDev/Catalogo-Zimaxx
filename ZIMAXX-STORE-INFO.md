...
>
> Creado: 2026-07-02. Última actualización: 2026-09-09, tercera tanda
...
> fila de edición desplegada, botón Vista completa (13 columnas), grupo
...
- **Vista completa** (2026-09-09, a pedido del usuario): botón **⤢ Vista
  ...
  siempre (6 columnas). La completa suma Empresa, Email (columna propia — la
  ...
  panel): 13 columnas, `colCount` alimenta los `colSpan` de las filas
